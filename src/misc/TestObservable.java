...
// It also explains the essence of event-driven programming model
package misc;
...
class InforSource extends Observable implements Runnable {
  public void run() {
...
class InforUser implements Observer {
