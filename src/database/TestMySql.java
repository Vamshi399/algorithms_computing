// Test SQL on a MySQL database 
// Before you run this program, make sure you have installed MySQL on your computer.
// Local MySQL has a database named "test", and a user "pace" with password 123456.
package database;
...
public class TestMySql {
  ...
  static String dbURL = "jdbc:mysql://localhost/test?allowPublicKeyRetrieval=true&useSSL=false";
  static String user = "pace";
